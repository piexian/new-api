...
const (
	...
	MsgAuthOAuthEmailRepair      = "auth.oauth_email_repair"
)
...
const (
	...
	MsgRedemptionRegistrationLimitPositive = "redemption.registration_limit_positive"
...
const (
	...
	MsgUserOAuthRegisterDisabled     = "user.oauth_register_disabled"
	...
	MsgUserDisabledWithReason        = "user.disabled_with_reason"
...
const (
	...
	MsgOAuthGitHubAccountTooYoung        = "oauth.github_account_too_young"
	MsgOAuthEmailAlreadyBound            = "oauth.email_already_bound"
	MsgOAuthOwnershipTransferRequired    = "oauth.ownership_transfer_required"
	MsgOAuthOwnershipTransferUnavailable = "oauth.ownership_transfer_unavailable"
	MsgOAuthOwnershipCodeSent            = "oauth.ownership_code_sent"
	MsgOAuthOwnershipCodeSendLimited     = "oauth.ownership_code_send_limited"
	MsgOAuthOwnershipCodeInvalid         = "oauth.ownership_code_invalid"
	MsgOAuthOwnershipTransferClosed      = "oauth.ownership_transfer_closed"
	MsgOAuthOwnershipCodeExpired         = "oauth.ownership_code_expired"
	MsgOAuthOwnershipTransferSuccess     = "oauth.ownership_transfer_success"
)
