...
export const channelSchema = z.object({
  ...
  status: z.number(), // 1: enabled, 2: manual disabled, 3: auto disabled, 4: rate limited
  name: z.string(),
...
export interface ChannelSettings {
  ...
  chat_completions_to_responses_enabled?: boolean
  chat_completions_to_responses_models?: string[]
  thinking_to_content?: boolean
  proxy?: string
  pass_through_body_enabled?: boolean
  upstream_openai_compat_enabled?: boolean
  zcode_mode_enabled?: boolean
