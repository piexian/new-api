...
export function ChannelMutateDrawer({
  ...
  const currentPlanQuotaCooldownEnabled = form.watch(
    'plan_quota_cooldown_enabled'
  )
  ...
  const routingStrategyConfigured = Boolean(
    ...
    (currentAutoBan ?? 1) !== 1 ||
    currentPlanQuotaCooldownEnabled
  )
  ...
  } else if (currentType === 68) {
    fieldPassthroughConfigured = Boolean(currentAllowServiceTier)
  }
                      ...
                      <ChannelApiAccessSection>
                        ...
                        <div className='border-border/60 bg-muted/10 rounded-lg border p-4'>
                          ...
                          >
                            ...
                            {/* Zhipu V4 (type 26) - Custom API URL */}
                            {currentType === 26 && customBaseUrlUnlocked && (
                              <>
                                <FormField
                                  control={form.control}
                            ...
                            {/* Moonshot / Kimi (type 25) - Custom API URL */}
                            {currentType === 25 && customBaseUrlUnlocked && (
                              <FormField
                                control={form.control}
                                name='base_url'
                            ...
                            {/* OpenCode (type 65) - Custom API URL */}
                            {currentType === 65 && customBaseUrlUnlocked && (
                              <FormField
                                control={form.control}
                                name='base_url'
