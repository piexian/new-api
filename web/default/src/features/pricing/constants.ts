...
export function getSortLabels(t: TFunction): Record<SortOption, string> {
  return {
    ...
    [SORT_OPTIONS.LISTED_NEWEST]: t('Recently added'),
    [SORT_OPTIONS.LISTED_OLDEST]: t('Earliest added'),
  }
}
...
export function getEndpointTypeLabels(
  ...
  return {
    ...
    [ENDPOINT_TYPES.GEMINI_INTERACTIONS]: 'Interactions',
    [ENDPOINT_TYPES.TYPESAFE]: 'TypeSafe',
