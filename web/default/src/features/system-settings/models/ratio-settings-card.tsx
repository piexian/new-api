...
const createGroupSchema = (t: Translate) =>
  z.object({
    ...
    HiddenUserGroups: createJsonStringField(t, {
      predicate: (parsed) =>
...
export function RatioSettingsCard({
  ...
  const groupNormalizedDefaults = useRef({
    ...
    HiddenUserGroups: normalizeJsonString(groupDefaults.HiddenUserGroups),
  ...
  const groupForm = useForm<GroupFormValues>({
    ...
    defaultValues: {
      ...
      HiddenUserGroups: formatJsonForTextarea(groupDefaults.HiddenUserGroups),
  ...
  const saveGroupRatios = useCallback(
    async (values: GroupFormValues) => {
      const normalized = {
        ...
        HiddenUserGroups: normalizeJsonString(values.HiddenUserGroups),
