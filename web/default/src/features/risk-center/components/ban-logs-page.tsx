...
export function BanLogsPage() {
  ...
  const totalPages = logs
    ? Math.max(1, Math.ceil(logs.total / (logs.page_size || 10)))
    : 1
  ...
  const truncate = (str: string | null | undefined, maxLen = 50) => {
    const value = str ?? ''
  ...
  return (
    <SectionPageLayout>
      <SectionPageLayout.Title>{t('Ban Logs')}</SectionPageLayout.Title>
        ...
        <div className='space-y-6'>
          ...
          <div className='flex flex-wrap items-end gap-4'>
            ...
            <div className='flex flex-col gap-1.5'>
              ...
              >
                <option value=''>{t('All')}</option>
                <option value='probe_guard'>{t('Probe Guard')}</option>
                <option value='error_ban'>{t('Error Ban')}</option>
                <option value='ip_middleware'>{t('IP Middleware')}</option>
                  ...
                  logs.items.map((log) => (
                    ...
                    >
                      ...
                      <td className='px-4 py-3'>
                        <Badge variant={dimensionBadgeVariant(log.dimension)}>
                          {log.dimension}
                        </Badge>
                      </td>
                      <td className='px-4 py-3 font-mono'>{log.target_ip}</td>
                      ...
                      <td className='px-4 py-3'>{formatTime(log.unban_at)}</td>
                      <td className='px-4 py-3 text-center'>
                        {log.dry_run ? (
              ...
              {selectedLog && (
                <div className='space-y-3 text-sm'>
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    ...
                    <span className='col-span-2'>
                      <Badge variant={sourceBadgeVariant(selectedLog.source)}>
                        {selectedLog.source}
                      </Badge>
                    </span>
                  </div>
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    ...
                    <span className='col-span-2'>{selectedLog.rule_name}</span>
                  </div>
                  <div className='grid grid-cols-3 gap-2'>
                    <span className='text-muted-foreground font-medium'>
                      {t('Action')}
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    ...
                    <span className='col-span-2 max-h-32 overflow-y-auto font-mono text-xs whitespace-pre-wrap'>
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    ...
                    <span className='col-span-2 break-words whitespace-pre-wrap'>
                      {selectedLog.models || '-'}
                    </span>
                  </div>
                  <div className='grid grid-cols-3 gap-2'>
