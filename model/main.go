...
func migrateLOGDB() error {
	...
	if err = LOG_DB.AutoMigrate(&EmailLog{}); err != nil {
		return err
	}
	return nil
}
...
` + "`weekly_quota_limit`" + ` bigint NOT NULL DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "daily_quota_limit", DDL: "`daily_quota_limit` bigint NOT NULL DEFAULT 0"},
		{Name: "weekly_quota_limit", DDL: "`weekly_quota_limit` bigint NOT NULL DEFAULT 0"},
		{Name: "monthly_quota_limit", DDL: "`monthly_quota_limit` bigint NOT NULL DEFAULT 0"},
