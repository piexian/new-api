...
func InitOptionMap() {
	...
	common.OptionMap["QQClientId"] = ""
	common.OptionMap["QQClientSecret"] = ""
	common.OptionMap["SteamWebAPIKey"] = ""
	...
	common.OptionMap["DefaultSubscriptionPlans"] = common.DefaultSubscriptionPlans
	...
	common.OptionMap["UserGroupConcurrencyLimit"] = setting.UserGroupConcurrencyLimit2JSONString()
	...
	common.OptionMap["HiddenUserGroups"] = setting.HiddenUserGroups2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "RegisterInviteCodeRequired" {
		...
		case "QQOAuthEnabled":
			common.QQOAuthEnabled = boolValue
	...
	case "QQClientId":
		common.QQClientId = value
	case "QQClientSecret":
		common.QQClientSecret = value
	case "Footer":
		common.Footer = value
	case "SystemName":
	...
	case "DefaultSubscriptionPlans":
		common.DefaultSubscriptionPlans = value
	...
	case "UserGroupConcurrencyLimit":
		err = setting.UpdateUserGroupConcurrencyLimitByJSONString(value)
	case "RetryTimes":
	...
	case "HiddenUserGroups":
		err = setting.UpdateHiddenUserGroupsByJSONString(value)
