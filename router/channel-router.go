...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/qwen/oauth/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartQwenOAuth},
	{method: http.MethodPost, path: "/qwen/oauth/complete", permission: authz.ChannelSensitiveWrite, handler: controller.CompleteQwenOAuth},
	...
	{method: http.MethodPost, path: "/:id/qwen/oauth/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartQwenOAuthForChannel},
	{method: http.MethodPost, path: "/:id/qwen/oauth/complete", permission: authz.ChannelSensitiveWrite, handler: controller.CompleteQwenOAuthForChannel},
